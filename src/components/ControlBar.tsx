...
export const ControlBar: React.FC<ControlBarProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-5 space-y-4">
      {/* Row 1: Gemini API Key & Language Selection */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
        ...
        <div className="lg:col-span-5">
          <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5 flex items-center justify-between">
            ...
            {apiKey.trim() ? (
              <span className="inline-flex items-center gap-1 text-[11px] text-emerald-600 font-medium lowercase">
                <CheckCircle2 className="w-3 h-3" /> 등록됨
              </span>
            ) : (
              <span className="text-[11px] text-amber-600 font-medium">필수 입력</span>
            )}
          </label>
